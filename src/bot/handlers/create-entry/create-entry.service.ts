...
export class CreateEntry extends BaseModel {
  ...
  notes: string | null;
  clone: boolean | null;
  constructor(data: CreateEntryData, user: string) {
    super();
...
export enum CreateEntryModalOptions {
  setTime = "setTime",
  setNote = "setNote",
}
...
export async function createEntryHandler(data: CreateEntryData, user: string) {
  ...
  // TODO: change return type if id is not used
